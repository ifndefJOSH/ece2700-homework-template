...
\begin{answer}
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	I can include graphics with \textbackslash\texttt{includegraphics} like this:
	\begin{figure}[h] % [h] means put (almost) here. You can include an extra package to include [H] which means put the figure EXACTLY here, or just include graphics not in a figure environment
		\begin{center}
		\includegraphics{engrLogo.png}
		\end{center}
		\caption{The Engineering Logo}
	\end{figure}
